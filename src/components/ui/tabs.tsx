...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot='tabs-list'
      className={cn(
        'inline-flex h-auto rounded-md p-1 text-zinc-900 ',
        className
      )}
      {...props}
    />
